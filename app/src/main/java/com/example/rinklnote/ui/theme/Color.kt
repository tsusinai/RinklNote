...
// Primary accent — used for selected items, active indicators, confirm button
val Blue80 = Color(0xFF7EC1FC)
...
val ExpenseRedText = Color(0xFFFF0000)
...
val IconDarkGray = Color(0xFF4C4C4C)

// Account brand colors
val WeChatGreen = Color(0xFF28C145)
val AlipayBlue = Color(0xFF06B4FD)
val DefaultOrange = Color(0xFFF97D1D)
